...
class _BookingState extends State<Booking> {
  ...
  /// Returns the user to the search page and shows them.
  /// the rating tab
  void _setShowRatingTab() {
    Navigator.of(context).pop();
    widget.showRatingTabFn();
  }
  ...
  Widget _price() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: <Widget>[
        MyText(content: 'Price'),
        MyText(content: 'Kes ${amount.toString()}'),
      ],
    );
  }
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Material(
              ...
              child: InkWell(
                onTap: () => _setShowRatingTab(),
                child: Center(
                  child: MyText(content: 'Pay now'),
                ),
              ),
                  ...
                  Expanded(
                    child: TimeDatePicker(
                        ...
                        leavingDate: leavingDate.day == DateTime.now().day
                            ? 'Today, '
                            : '${leavingDate.day.toString()}/${leavingDate.month.toString()}/${leavingDate.year.toString()},',
